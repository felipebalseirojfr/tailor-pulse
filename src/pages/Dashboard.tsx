      ...
      <div className="fixed inset-0 z-50 bg-background overflow-hidden">
        ...
        <div className="p-8 space-y-6 h-[calc(100vh-80px)] overflow-hidden">
          <div className="grid grid-cols-5 gap-4">
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-6 text-center">
                <div className="flex justify-center mb-2"><Timer className="h-8 w-8 text-blue-500" /></div>
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-6 text-center">
                <div className="flex justify-center mb-2"><Target className="h-8 w-8 text-yellow-500" /></div>
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-6">
                ...
                <div className="mt-4 h-2 bg-muted rounded-full overflow-hidden">
                  <div className="h-full bg-green-500 rounded-full transition-all duration-500" style={{ width: `${stats.taxaConclusao}%` }} />
                </div>
              </CardContent>
            </Card>
            <Card className="bg-card border-border">
